...
function GithubIcon({ pixelSize }: { pixelSize: number }) {
  return (
    <svg
      aria-hidden="true"
      fill="currentColor"
...
function LinkedinIcon({ pixelSize }: { pixelSize: number }) {
  return (
    <svg
      aria-hidden="true"
      fill="currentColor"
...
export function SocialIconLinks({
  ...
  const pixelSize = size === "xs" ? 14 : size === "md" ? 18 : 16;
        ...
        <Link asChild>
          <NextLink href={githubUrl} rel="noreferrer" target="_blank">
            <IconButton aria-label="Open GitHub profile" color="muted" size={size} variant="ghost">
              <GithubIcon pixelSize={pixelSize} />
            </IconButton>
          </NextLink>
        </Link>
      )}
        ...
        <Link asChild>
          <NextLink href={linkedinUrl} rel="noreferrer" target="_blank">
            <IconButton aria-label="Open LinkedIn profile" color="muted" size={size} variant="ghost">
              <LinkedinIcon pixelSize={pixelSize} />
            </IconButton>
          </NextLink>
        </Link>
      )}
